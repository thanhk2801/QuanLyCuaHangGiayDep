...
namespace Quanlygiaydepca2.Class
{
    class Quanlygiaydep
    {
        ...
        public static void Connect()
        {
            ...
            connString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Administrator\source\repos\Quanlygiaydepca2\Quanlygiaydepca2\Database\Quanlygiaydepca2.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        {
            SqlDataAdapter Mydata = new SqlDataAdapter(sql, Quanlygiaydep.Conn);
        ...
        public static DataTable GetDataToTable(string sql)
        {
            ...
            Mydata.SelectCommand.Connection = Quanlygiaydep.Conn; 	// Kết nối CSDL
        ...
        public static void RunSql(string sql)
        {
            ...
            cmd.Connection = Quanlygiaydep.Conn;	  // Gán kết nối
        ...
        public static void RunSqlDel(string sql)
        {
            ...
            cmd.Connection = Quanlygiaydep.Conn;
            cmd.CommandText = sql;
            try
            {
                cmd.ExecuteNonQuery();
